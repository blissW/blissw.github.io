...
const ipgeolocation = 'https://api.ipgeolocation.io/ipgeo?apiKey=937233389b1946918ec394a97a183ad6';
...
$(document).ready(() => {
  ...
  for (let i in links) {
    ...
    $('#marquee').append(`bliss <img class="emoticon" src="assets/others/mgh_17.png"> skid exposer <img class="emoticon" src="assets/others/mgh_17.png"> asmatikka daddy>.< <img class="emoticon" src="assets/others/mgh_17.png"> PDAT Co-Founder. <img class="emoticon" src="assets/others/mgh_17.png"> Lil Dulcet <img class="emoticon" src="assets/others/mgh_17.png"> 0Pdat <img class="emoticon" src="assets/others/mgh_17.png"> 69Meli <img class="emoticon" src="assets/others/mgh_17.png"> pro coder`);
  ...
  app.titleChanger(['bliss', 'sugar daddy', '0pdat', 'zFrozz']);
